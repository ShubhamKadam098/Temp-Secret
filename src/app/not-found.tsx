...
const PageNotFound = () => {
  return (
    <>
      <Navbar />
      <main className="mx-auto flex min-h-screen w-full max-w-7xl items-center px-4 pb-12 pt-28 sm:px-6 lg:px-10">
        <div className="grid w-full gap-10 lg:grid-cols-[minmax(0,420px)_minmax(0,1fr)] lg:items-center">
          <div className="space-y-6 text-center lg:text-left">
            <p className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground">
              Not found
            </p>
            <p className="text-7xl font-semibold tracking-tight text-foreground sm:text-8xl lg:text-9xl">
            404
            </p>
            <div className="space-y-3">
              ...
              <p className="text-base leading-7 text-muted-foreground">
                The page you requested does not exist, or the link has already expired.
              </p>
            </div>
            <Button asChild>
              <Link href="/" className="inline-flex items-center gap-2" title="Return Home">
          ...
          >
            ...
            <circle cx="212.59226" cy="103" r="64" fill="#ffffff"></circle>
            <path
